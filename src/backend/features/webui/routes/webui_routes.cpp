...
void webui_route_read(webui::window::event *e) {
    ...
    spdlog::debug(
        "Returning settings id={}, kiosk={}, width={}, height={}, x={}, y={}",
...
void webui_route_update_kiosk(webui::window::event *e) {
    ...
    if (!validate_field(request, "kiosk", json::value_t::boolean)) {
        ...
        e->return_string(
            make_response(true, "Missing or invalid type for: kiosk").dump());
        return;
    }
    ...
    if (!settings) {
        ...
        e->return_string(
            make_response(true, "Failed to update kiosk mode").dump());
        return;
    }
...
void webui_route_update_size(webui::window::event *e) {
    ...
    if (!validate_field(request, "width", json::value_t::number_unsigned)) {
        ...
        e->return_string(
            make_response(true, "Missing or invalid type for: width").dump());
        return;
    }
    ...
    if (!validate_field(request, "height", json::value_t::string)) {
        ...
        e->return_string(
            make_response(true, "Missing or invalid type for: height").dump());
        return;
    }
...
void webui_route_update_pos(webui::window::event *e) {
    ...
    if (!validate_field(request, "x", json::value_t::number_unsigned)) {
        ...
        e->return_string(
            make_response(true, "Missing or invalid type for: x").dump());
        return;
    }
    ...
    if (!validate_field(request, "y", json::value_t::string)) {
        ...
        e->return_string(
            make_response(true, "Missing or invalid type for: y").dump());
        return;
    }
